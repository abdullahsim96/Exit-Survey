...
T = {
    "en": {
        ...
        "workload_deadlines": "I clearly understood how my performance would be measured and what it would take to achieve my targets. *",
    ...
    "ar": {
        ...
        "workload_deadlines": "كنت أفهم بوضوح كيف يتم قياس أدائي وما المطلوب لتحقيق أهدافي. *",
